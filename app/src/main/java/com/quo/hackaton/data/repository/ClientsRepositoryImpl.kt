...
class ClientsRepositoryImpl@Inject constructor(
    ...
    private val mockList = listOf(
        Company(UUID.fromString("41257245-4c3c-4645-806c-da853ad203ac"), "Частный", "Краснодарский край, г Краснодар, улица Митрофана Седина, д. 191", 45.040419, 38.982302),
        Company(UUID.fromString("4e72309a-938c-4bae-b2a8-04b7760b14ff"), "Частный", "Краснодарский край, г Краснодар, улица Циолковского, д. 122",     45.088815, 38.979185),
        Company(UUID.fromString("5faabb1b-aa0a-4b9b-9e82-78c936c49cfa"), "Частный","Краснодарский край, посёлок Южный улица Мира, д. 70,", 45.150114, 39.020058),
        Company(UUID.fromString("14d7bf15-be56-46d0-ae51-3e53b5821445"), "Частный", "Краснодарский край, г Краснодар, Плановый проезд, д. 5", 45.034133, 39.016689),
        Company(UUID.fromString("41f02f06-2032-4807-acfe-73e81918b3a1"), "Частный", "Краснодарский край, г Краснодар, Восточно-Кругликовская улица, 48/2", 45.060191, 39.027963),
        Company(UUID.fromString("dea09a8c-ecfa-426c-902c-5b5532f1148e"), "Прочий", "Краснодарский край, г Краснодар, Черниговская улица, д 1", 45.039731, 39.018226),
        Company(UUID.fromString("28f1f606-d8fc-4b26-83e1-0798e774baf8"), "Частный", "Республика Адыгея, р-н Тахтамукайский, аул Козет, ул Шоссейная, д. 44", 44.990542, 38.998400),
